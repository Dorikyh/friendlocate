...
const featuresData: Feature[] = [
  {
    ...
    paragraph:
      "Friend Locate no solo rastrea la ubicación de personas y mascotas, sino que también ofrece una visualización en tiempo real a través de su cámara integrada, lo que proporciona tranquilidad adicional a los usuarios.",
  },
  {
    id: 2,
    icon: (
    ...
    paragraph:
      "Nuestra tecnología de rastreo utiliza sistemas de posicionamiento avanzados para garantizar una ubicación precisa en todo momento, lo que brinda mayor tranquilidad.",
  },
  {
    id: 3,
    icon: (
